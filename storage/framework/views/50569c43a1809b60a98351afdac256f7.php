...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'JobHub - Recruitment Portal'); ?></title>
...
<body class="bg-gray-50 antialiased" x-data="appState()" x-cloak>
    ...
    <?php if(request()->is('auth/*') || request()->is('reset-password') || request()->is('password/*')): ?>
        <!-- Auth Layout -->
        <div class="min-h-screen bg-white">
            <?php echo $__env->yieldContent('content'); ?>
        </div>
    <?php elseif(request()->is('dashboard/*') || request()->is('admin/*') || request()->is('employer/*') || request()->is('candidate/*') || request()->is('applications/*') || request()->is('companies/*') || request()->is('categories/*') || request()->is('jobs/create') || request()->is('jobs/*/edit') || request()->is('profile') || request()->is('settings')): ?>
    ...
    <?php echo $__env->make('components.error-notification', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\Job Recuitment System\recruitment-portal\resources\views/layouts/app.blade.php ENDPATH**/ ?>