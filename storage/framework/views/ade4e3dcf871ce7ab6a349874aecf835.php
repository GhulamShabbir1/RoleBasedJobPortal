            ...
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex items-center space-x-4">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="text-gray-300 hover:text-white transition-colors">Dashboard</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('auth.login')); ?>" class="text-gray-300 hover:text-white transition-colors">Login</a>
                        <a href="<?php echo e(route('auth.signup')); ?>" class="bg-white text-black px-5 py-2 rounded-lg font-semibold hover:bg-gray-200 transition-all hover:scale-105">
                            Sign Up
                        </a>
                    <?php endif; ?>
                </div>
                ...
                <div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 animate-slideInLeft delay-200">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <a href="<?php echo e(route('auth.signup')); ?>" class="group border border-white/30 text-white px-8 py-3 rounded-lg font-semibold hover:bg-white/10 transition-all hover:scale-105 flex items-center justify-center">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <?php if(auth()->guard()->guest()): ?>
                <div class="flex flex-col sm:flex-row justify-center gap-4 animate-fadeInUp delay-200">
                    <a href="<?php echo e(route('auth.signup')); ?>?role=candidate" class="group bg-white text-black px-8 py-3 rounded-lg font-semibold hover:bg-gray-200 transition-all hover:scale-105 flex items-center justify-center">
                        <i class="fas fa-user mr-2"></i>
                        <span>I'm a Candidate</span>
                        <i class="fas fa-arrow-right ml-2 group-hover:translate-x-1 transition-transform"></i>
                    </a>
                    <a href="<?php echo e(route('auth.signup')); ?>?role=employer" class="group border border-white/30 text-white px-8 py-3 rounded-lg font-semibold hover:bg-white/10 transition-all hover:scale-105 flex items-center justify-center">
...
<?php /**PATH C:\xampp\htdocs\Job Recuitment System\recruitment-portal\resources\views/welcome.blade.php ENDPATH**/ ?>