        ...
        <div class="mb-4">
            ...
            <nav class="space-y-1">
                ...
                <a href="{{ route('dashboard.admin') }}"
                   class="flex items-center px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-all duration-200 group {{ request()->routeIs('dashboard.admin') ? 'bg-gray-900 text-white shadow-lg hover:bg-gray-800' : '' }}">
                    ...
                    <span class="ml-auto text-xs {{ request()->routeIs('dashboard.admin') ? 'text-white/50' : 'text-gray-400' }}">
                ...
                <a href="{{ route('users.manage') }}"
                   class="flex items-center px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-all duration-200 group {{ request()->routeIs('users.manage') ? 'bg-gray-900 text-white shadow-lg hover:bg-gray-800' : '' }}">
                    ...
                    <span class="ml-auto text-xs {{ request()->routeIs('users.manage') ? 'text-white/50' : 'text-gray-400' }}">
                        <i class="fas fa-chevron-right"></i>
                    </span>
                </a>

                <!-- Companies -->
                <a href="{{ route('page.admin.companies.index') }}"
                   class="flex items-center px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-all duration-200 group {{ request()->routeIs('page.admin.companies.index') ? 'bg-gray-900 text-white shadow-lg hover:bg-gray-800' : '' }}">
                    <div class="w-8 h-8 rounded-lg flex items-center justify-center mr-3 {{ request()->routeIs('page.admin.companies.index') ? 'bg-white/10' : 'bg-gray-100 group-hover:bg-gray-200' }}">
                        <i class="fas fa-building text-sm {{ request()->routeIs('page.admin.companies.index') ? 'text-white' : 'text-gray-500' }}"></i>
                    </div>
                    <span class="font-medium">Companies</span>
                    <span class="ml-auto text-xs {{ request()->routeIs('page.admin.companies.index') ? 'text-white/50' : 'text-gray-400' }}">
                        <i class="fas fa-chevron-right"></i>
                    </span>
                </a>
                ...
                <a href="{{ route('admin.categories.manage') }}"
                   class="flex items-center px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-all duration-200 group {{ request()->routeIs('admin.categories.manage') ? 'bg-gray-900 text-white shadow-lg hover:bg-gray-800' : '' }}">
                    ...
                    <span class="ml-auto text-xs {{ request()->routeIs('admin.categories.manage') ? 'text-white/50' : 'text-gray-400' }}">
                        <i class="fas fa-chevron-right"></i>
                    </span>
                </a>
                ...
                <a href="{{ route('admin.jobs.manage') }}"
                   class="flex items-center px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-all duration-200 group {{ request()->routeIs('admin.jobs.manage') ? 'bg-gray-900 text-white shadow-lg hover:bg-gray-800' : '' }}">
                    ...
                    <span class="ml-auto text-xs {{ request()->routeIs('admin.jobs.manage') ? 'text-white/50' : 'text-gray-400' }}">
                        <i class="fas fa-chevron-right"></i>
                    </span>
                </a>

                <!-- Applications -->
                <a href="{{ route('page.admin.applications.index') }}"
                   class="flex items-center px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-all duration-200 group {{ request()->routeIs('page.admin.applications.index') ? 'bg-gray-900 text-white shadow-lg hover:bg-gray-800' : '' }}">
                    <div class="w-8 h-8 rounded-lg flex items-center justify-center mr-3 {{ request()->routeIs('page.admin.applications.index') ? 'bg-white/10' : 'bg-gray-100 group-hover:bg-gray-200' }}">
                        <i class="fas fa-inbox text-sm {{ request()->routeIs('page.admin.applications.index') ? 'text-white' : 'text-gray-500' }}"></i>
                    </div>
                    <span class="font-medium">Applications</span>
                    <span class="ml-auto text-xs {{ request()->routeIs('page.admin.applications.index') ? 'text-white/50' : 'text-gray-400' }}">
                        <i class="fas fa-chevron-right"></i>
                    </span>
                </a>
            </nav>
    ...
    <div class="p-4 border-t border-gray-200">
        <div class="flex items-center space-x-3 p-3 rounded-xl hover:bg-gray-50 transition-all duration-200 cursor-pointer">
            ...
            <div class="flex-1 min-w-0">
                ...
                <p class="text-xs text-gray-500 truncate">{{ auth()->user()->email ?? 'admin@jobhub.com' }}</p>
            </div>
