                ...
                <div class="space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            ...
                            <p class="text-gray-600 mt-1">Complete your profile to get noticed by employers</p>
                        </div>
    ...
    return {
        ...
        async loadProfile() {
            ...
            try {
                ...
                // 404 is expected when creating new profile
        ...
        resetForm() {
            if (confirm('Are you sure you want to reset the form?')) {
                this.form = {
                    ...
                    education: '',
                    resume: null,
                    resume_url: this.form.resume_url || ''
                };
                this.error = '';
                this.success = '';
                this.newSkill = '';
                ...
                try {
                    ...
                    if (createError.response?.status === 409) {
                        ...
                        if (profileResponse.data.success && profileResponse.data.data?.id) {
                            ...
                            if (updateResponse.data.success) {
                                ...
                                if (updateResponse.data.data?.id) {
                                    const user = JSON.parse(localStorage.getItem('user') || '{}');
                                    user.profile_id = updateResponse.data.data.id;
                                    localStorage.setItem('user', JSON.stringify(user));
                                }
                        ...
                        if (errors) {
                            ...
                            this.error = createError.response?.data?.message || 'An error occurred. Please try again.';
                        }
                    }
                }
            } catch (error) {
